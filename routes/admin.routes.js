...
const User = require('../model/Users.model'); // Corrected import path
const authMiddleware = require('../middlewares/adminMiddleware'); // Corrected import path
const adminMiddleware = require('../middlewares/adminMiddleware'); // Corrected import path

// Assuming Role model exists
// const Role = require('../model/Role.js'); // Make sure this file exists

// GET /api/admin/dashboard - Overview of key metrics
...
// GET /api/admin/reports/sales - Sales report for a date range
...
// POST /api/admin/permissions - Create/update permissions
...
// GET /api/admin/tasks - List of tasks
...
// POST /api/admin/notifications - Send notifications to roles
